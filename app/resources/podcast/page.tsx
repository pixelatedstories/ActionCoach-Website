    ...
    <div className="pt-32 pb-24 bg-[#1C1C1C]">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start border-t border-white/5 pt-12">
          <div>
            ...
            <p className="text-xl text-white/60 leading-relaxed mb-8">
              Real conversations with business owners on what it actually takes to build a business that works without you. Hosted by Bill Gilliland — award-winning business coach and five-time business owner.
            </p>
            <p className="text-white/50 leading-relaxed mb-12">
              Each episode covers the decisions, systems, and mindset shifts that separate owners who are trapped inside their business from the ones who lead it. No fluff, no motivation-only content — just the work.
            </p>
        ...
        <div className="mt-24 p-12 bg-white text-black text-center">
          <h2 className="text-3xl font-black uppercase mb-4 leading-tight">Want coaching, not just content?</h2>
