...
const pricingItems = [
  ...
  },
  {
    ...
    description: 'One-on-one strategic coaching for owners who want higher-level accountability and execution. Includes the ActionCOACH Business Operating System (ABoS).',
  },
  {
    name: 'ProfitClub',
    price: '$500',
    period: 'per month (or $5,500/year)',
    description: 'Bi-weekly group coaching with peer accountability, KPI tracking, and the ActionCOACH framework.',
  },
  {
  ...
  {
    name: '2 Weeks Free Coaching',
    price: 'Free',
    period: 'no obligation',
    description: 'Two coaching sessions with an executable 90-day plan. A risk-free way to experience ActionCOACH.',
  },
  {
