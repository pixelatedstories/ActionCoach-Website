        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 md:px-8">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              <Link href="/pricing" className="inline-block bg-gold text-black px-6 py-5 md:px-8 md:py-6 text-sm font-black uppercase tracking-wider md:tracking-widest leading-tight hover:bg-white transition-all transform hover:scale-105 text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-[#1C1C1C] p-10 shadow-2xl">
            ...
            <p className="text-white text-lg mb-8 leading-relaxed italic">
              &ldquo;Bill Gilliland is a seasoned entrepreneur who understands real-world challenges. He doesn&apos;t just teach theory — he delivers EPIC results.&rdquo;
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <Link
                href="/programs/one-to-one-freedom"
            ...
            <div className="space-y-8">
              <AbosStep number="1" title="Mastery" description="Gain control over time, money, delivery, and direction. Master your schedule, ensure financial clarity, streamline operations, and set a clear path forward." />
              <AbosStep number="2" title="Marketing" description="Create predictable cash flow with a clear niche and the 5 Ways formula. Define your ideal customer, craft compelling offers, and generate consistent leads." />
              <AbosStep number="3" title="Systems" description="Install processes that drive consistency and scale. Build efficient workflows, automate repetitive tasks, and run your business like a well-oiled machine." />
              <AbosStep number="4" title="Team" description="Build a high-performance team that delivers results without you. Recruit the right people, foster accountability, and empower your team to own their results." />
              <AbosStep number="5" title="Scale" description="Multiply growth through strategy, mission, and execution. Develop a clear growth roadmap, align your team, and execute with precision." />
              <AbosStep number="6" title="Freedom" description="Step back, sell, or expand — your business runs smoothly without you. Take a real vacation. Plan a profitable exit. Or scale to new heights." />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 grid md:grid-cols-3 gap-8">
          {corePrograms.map((p) => (
            <div key={p.id} className="group p-8 border border-white/10 hover:border-gold transition-all bg-[#1C1C1C] flex flex-col h-full">
              ...
              <Link href={`/programs/${p.id}`} className="inline-block py-3 border-b-2 border-gold font-black text-xs uppercase tracking-widest group-hover:bg-gold group-hover:text-black group-hover:px-4 transition-all">
                Learn More
              </Link>
            </div>
          ))}
      ...
      <section className="py-32 bg-gold text-black text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/pricing" className="inline-block bg-black text-white px-8 py-5 md:px-12 md:py-6 text-base md:text-lg font-black uppercase tracking-wider md:tracking-widest leading-tight hover:bg-white hover:text-black transition-all shadow-xl">
              Get Your Instant Estimate
            </Link>
            <Link href="/book" className="inline-block border-2 border-black text-black px-8 py-5 md:px-12 md:py-6 text-base md:text-lg font-black uppercase tracking-wider md:tracking-widest leading-tight hover:bg-black hover:text-white transition-all shadow-xl">
