    ...
    <div className="pt-32 pb-24 bg-[#1C1C1C]">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-xl text-white/60 mb-8 italic">
                  {isSpeaking
                    ? '"Book Bill to bring authentic expertise to your stage."'
                    : '"If you\'re seeking a personalized path to freedom, this is your answer."'
                  }
                </p>
                <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {program.investmentOptions.map((opt, i) => (
                <div key={i} className={`p-10 border-2 ${i === 1 ? 'border-gold bg-gold/5' : 'border-white/10 bg-[#262626]'} flex flex-col`}>
                  ...
                  <p className="text-white/70 mb-10 flex-grow leading-relaxed italic">&ldquo;{opt.description}&rdquo;</p>
        ...
        <div className="mt-24 p-12 bg-white text-black text-center">
          <h2 className="text-3xl md:text-5xl font-black uppercase mb-8 leading-tight">Not sure this is the right fit yet?</h2>
          <Link href="/scorecard" className="inline-block bg-black text-white px-12 py-6 text-lg font-black uppercase tracking-widest hover:bg-gold hover:text-black transition-all shadow-2xl">
            Take the Scorecard
          </Link>
        </div>
      </div>
