...
const ProgramTwelveWeekMasterclasses: React.FC = () => {
  return (
    <div className="pt-32 pb-24 bg-[#1C1C1C]">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="mt-12 p-12 bg-white text-black text-center">
          ...
          <Link to="/book" className="inline-block bg-black text-white px-12 py-6 text-lg font-black uppercase tracking-widest hover:bg-gold hover:text-black transition-all shadow-2xl">
...
export default ProgramTwelveWeekMasterclasses;
