...
const Booking: React.FC = () => {
  return (
    <div className="pt-32 pb-24 bg-[#1C1C1C]">
      <SEO
        title="Book a Free Business Strategy Session | ActionCOACH NC & SC"
        description="Schedule your free 15-minute strategy session with ActionCOACH. No obligation. Helping business owners achieve more throughout North and South Carolina."
        canonical="/book"
      />
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="bg-[#262626] p-4 md:p-8 shadow-2xl border border-white/10">
          <CalendlyEmbed url={`${CONTACT.CALENDLY}?back=1`} />
        </div>
